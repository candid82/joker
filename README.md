...
Joker requires Go v1.9 or later. Joker's only dependency is [readline](https://github.com/chzyer/readline).
Below commands should get you up and running. Ignore error messages about undefined `*Data` variables after you run `go get`: they will be generated by `go generate`.
