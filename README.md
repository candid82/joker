...
Below commands should get you up and running. *NOTE:* Ignore error messages about undefined `*Data` variables after you run `go get`: they will be generated by `go generate`.
