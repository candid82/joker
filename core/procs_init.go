...
func init() {
	...
	intern("find-var__", procFindVar_thunk, "procFindVar_thunk")
	intern("sort__", procSort, "procSort")
	intern("eval__", procEval_thunk, "procEval_thunk")
	...
	intern("pr__", procPr_thunk, "procPr_thunk")
	intern("pprint__", procPprint_thunk, "procPprint_thunk")
	intern("newline__", procNewline_thunk, "procNewline_thunk")
	intern("flush__", procFlush, "procFlush")
	intern("read__", procRead_thunk, "procRead_thunk")
	intern("read-line__", procReadLine_thunk, "procReadLine_thunk")
	intern("reader-read-line__", procReaderReadLine, "procReaderReadLine")
	intern("read-string__", procReadString_thunk, "procReadString_thunk")
	intern("nano-time__", procNanoTime, "procNanoTime")
	intern("macroexpand-1__", procMacroexpand1_thunk, "procMacroexpand1_thunk")
	intern("load-string__", procLoadString_thunk, "procLoadString_thunk")
	intern("find-ns__", procFindNamespace_thunk, "procFindNamespace_thunk")
	intern("create-ns__", procCreateNamespace_thunk, "procCreateNamespace_thunk")
	intern("inject-ns__", procInjectNamespace_thunk, "procInjectNamespace_thunk")
	intern("remove-ns__", procRemoveNamespace_thunk, "procRemoveNamespace_thunk")
	intern("all-ns__", procAllNamespaces_thunk, "procAllNamespaces_thunk")
	...
	intern("ns-initialized?__", procIsNamespaceInitialized_thunk, "procIsNamespaceInitialized_thunk")
	...
	intern("ns-resolve__", procNsResolve_thunk, "procNsResolve_thunk")
	...
	intern("load-file__", procLoadFile_thunk, "procLoadFile_thunk")
	intern("load-lib-from-path__", procLoadLibFromPath_thunk, "procLoadLibFromPath_thunk")
	...
	intern("lib-path__", procLibPath_thunk, "procLibPath_thunk")
	intern("intern-fake-var__", procInternFakeVar_thunk, "procInternFakeVar_thunk")
	intern("parse__", procParse_thunk, "procParse_thunk")
