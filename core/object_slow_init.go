...
func init() {
	TYPE = Types{
		...
		Editable:               RegInterface("Editable", (*Editable)(nil), ""),
		TransientCollection:    RegInterface("TransientCollection", (*TransientCollection)(nil), ""),
		TransientAssociative:   RegInterface("TransientAssociative", (*TransientAssociative)(nil), ""),
		TransientMapCollection: RegInterface("TransientMapCollection", (*TransientMapCollection)(nil), ""),
		TransientSetCollection: RegInterface("TransientSetCollection", (*TransientSetCollection)(nil), ""),
		...
		TransientVector:        RegRefType("TransientVector", (*TransientVector)(nil), ""),
		TransientArrayMap:      RegRefType("TransientArrayMap", (*TransientArrayMap)(nil), ""),
		TransientHashMap:       RegRefType("TransientHashMap", (*TransientHashMap)(nil), ""),
		TransientSet:           RegRefType("TransientSet", (*TransientSet)(nil), ""),
